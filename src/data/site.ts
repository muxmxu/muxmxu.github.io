...
export const copy = {
  en: {
    ...
    hero: {
      ...
      bio: 'I am a doctoral student at Keio University and a member of the Takamichi Lab. I work on spatial voice conversion, spatial audio, and machine learning for speech and audio.',
  ...
  ja: {
    ...
    hero: {
      ...
      bio: '慶應義塾大学・高道研究室に所属する博士課程学生です。空間Voice Conversion、空間オーディオ、音声・音響のための機械学習に取り組んでいます。',
  ...
  zh: {
    ...
    hero: {
      ...
      bio: '现为庆应义塾大学高道研究室博士生，主要研究空间语音转换、空间音频，以及面向语音和音频的机器学习。',
      detailsLabel: '学术信息',
      facts: [
